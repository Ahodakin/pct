                    ...
                    <div class="col-lg-6 wow fadeIn" data-wow-delay=".5s">
                        <div class="p-5 rounded contact-form">
                            <div class="mt-3 text-center">
                                <h4>S'inscrire en tant que artisan</h4>
                            </div>
                            <form>
                                <div class="row mt-3">
                                    <div class="col">
                                ...
                                <div class="mb-3">
                                    <label for="exampleInputtel" class="form-label">Photo de profil</label>
                            ...
                            <div class="mt-3">
                                <p><a href="index.php" class="text-decoration-none"><i class="fas fa-home"></i> Accueil</a></p>
                            </div>
                        </div>
                    </div>
                </div>
